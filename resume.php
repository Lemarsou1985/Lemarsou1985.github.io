...
<head>
    <meta charset="utf-8" />
    <title>Leandro Martins de Souza</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Leandro Martins de Souza" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Leandro Martins de Souza" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/capa.jpeg" alt="Leandro Martins de Souza">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Leandro Martins de Souza</h4>
                        <div class="status"> Aprendiz de Desenvolvedor WEB</div>
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/leandro-martins-5722a8145/">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/Lemarsou1985">
                    ...
                    <ul class="header__contact">
                        ...
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=+55063xxxxxxxxxxx">+55 (xx) xxxxx-xxxx </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Pós graduação em Planejamento e
                                            Orçamento Público
                                        </h5>
                                        <span class="timeline__period">2014 — 2015</span>
                                        <p class="timeline__description">
                                            Universidade Cândido Mendes</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Bacharelado em Ciências Contábeis
                                        </h5>
                                        <span class="timeline__period">2008 — 2012</span>
                                        <p class="timeline__description">Faculdade São Francisco de Barreiras </p>
                                    </article>
                                    ...
                                    <article class="timeline__item">
                                        ...
                                        <p class="timeline__description">IFTO - Instituto Federal do Tocantins
                                            Informação.</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        ...
                                        <span class="timeline__period">2020 — 2020</span>
                                        <p class="timeline__description">UDEMY</p>
                                        <ul>
                                            <li>01 - FORMAÇÃO NODE.JS</li>
                                            <li>02 - WEB DEVELOPMENT BOOTCAMP 2020</li>
                                            <li>03 - PROGRAMAÇÃO EM PYTHON DO BÁSICO AO AVANÇADO</li>
                                        </ul>
                                    </article>
                                    <article class="timeline__item">

                                        <span class="timeline__period">2019 — 2020</span>
                                        <p class="timeline__description">FUNDAÇÃO BRADESCO</p>
                                        <ul>
                                            <li>01 - INOVANDO COM CSS</li>
                                            <li>02 - HTML BÁSICO</li>
                                            <li>03 - LÓGICA DA PROGRAMAÇÃO</li>
                                            <li>04 - BANCO DE DADOS CONCEITOS BÁSICOS</li>
                                        </ul>
                                    </article>
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Certificação CBPA</h5>
                                        <span class="timeline__period">2020</span>
                                        <p class="timeline__description">Abpmp Brasil</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Certificação CBPP</h5>
                                        <span class="timeline__period">2019</span>
                                        <p class="timeline__description">Abpmp Brasil</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Certificação OKRCP</h5>
                                        <span class="timeline__period">2018</span>
                                        <p class="timeline__description">MEETUP BR</p>
                                    </article>
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">analista e desenvolvedor web</h5>
                                        <span class="timeline__period">2020 — Presente</span>
                                        <p class="timeline__description"> Analisar e verificar a execução de projetos de
                                            desenvolvimento de software interagindo com menbro da empresa e
                                            profissionais de divesos setores, além de clientes e colaboradores.</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Digitador</h5>
                                        <span class="timeline__period">2019 — 2020</span>
                                        <p class="timeline__description">Dentre as principais responsabilidades,
                                            digitalizar o acervo físico da empresa, corrigindo possíveis erros e
                                            atualizando com as normativas em vigor.</p>
                                    </article>
                                    <!-- Item -->
                                ...
                                <div class="box box__border">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="60"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>WordPress</span><span>12%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="25"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>JavaScript</span><span>25%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="33"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>Node.js</span><span>33%</span></div>
                                        </div>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Leandro Martins de Souza</footer>
                </div>
            </div>
        </div>
    </main>
