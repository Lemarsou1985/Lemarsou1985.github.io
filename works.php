                ...
                <div class="header__left">
                    ...
                    <div class="header__base-info">
                        ...
                        <ul class="header__social">
                            <li>
                                <a href="www.linkedin.com/in/leandro-martins-5722a8145/">
                            ...
                            <div class="gallery-grid js-grid-row js-filter-container">
                                ...
                                <figure class="gallery-grid__item category-html category-js">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/JAVA.jpg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">JAVA</h4>
                                        <span class="gallery-grid__category">Javascript.com </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/css.jpg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class=" gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">css</h4>
                                        <span class="gallery-grid__category">www.w3schools.com </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/html.png"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">html</h4>
                                        <span class="gallery-grid__category">www.w3schools.com</span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-html category-wordpress category-php">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/PHP.png"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">PHP</h4>
                                        <span class="gallery-grid__category">www.php.net </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/wordpress.png"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">wordpress</h4>
                                        <span class="gallery-grid__category">https://br.wordpress.com/ </span>
                                    </figcaption>
                                </figure>
